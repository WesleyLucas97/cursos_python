...
Listas em Python funcionam como vetores/matrizes, arreys em outras linguagens, com a diferença de serem
...
# OBS: Não substitui o valor inicial. O mesmo será deslocado para a direita da lista.
...
lista6 = [1, 2.34, True, 'Geek', 'd', [1, 2, 3], 6451651681685]
print(lista6)
print(type(lista6))
...
# Veja que ao utilizarmos lista.copy() copiamos os dados da lista para uma nova lista, mas eles ficaram totalmente
...
# Veja que utilizando a cópia via atribuição e copiando os dados da lista para a nova lista, mas após realizar uma
# em uma das listas, essa modificação se refletiu em ambas as listas. Isso em python é chamado de Shallow Copy
"""
